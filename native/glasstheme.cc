...
void setglasstheme(const Napi::CallbackInfo &info) {
...
void disableglasstheme(const Napi::CallbackInfo &info) {
    Napi::Env env = info.Env();
    try {
        if (info.Length() != 1) {
            Napi::TypeError::New(env, "WINDOW_NOT_GIVEN").ThrowAsJavaScriptException();
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
    exports.Set(Napi::String::New(env, "setglasstheme"),
                Napi::Function::New(env, setglasstheme));
    exports.Set(Napi::String::New(env, "disableglasstheme"),
                Napi::Function::New(env, disableglasstheme));
    return exports;
}

NODE_API_MODULE(glasstheme, Init
)
